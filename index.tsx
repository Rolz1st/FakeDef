...
// Avoid unnecessary imports and ensure the code doesn't throw errors
const { React, findByPropsLazy, findStoreLazy, useState, useEffect } = require('@webpack');
const { Keyboard } = require('@electron/keyboard');
